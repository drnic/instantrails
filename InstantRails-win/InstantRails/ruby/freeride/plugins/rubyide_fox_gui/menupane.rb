...
#
# $Id: menupane.rb,v 1.6 2005/02/19 14:48:52 ljulliar Exp $
#
      ...
      class Renderer
        ...
        def update(event)
          ...
          @slot.manager.each_command do | cmd_slot, text, description, available, accelerator |
            begin
              if text == "SEPARATOR"
                cmd_slot.attr_fxmenu = FXMenuSeparator.new(@menu)
              else
                menu_text = text
                menu_text += "\t"
