...
#
# $Id: editpane_configurator.rb,v 1.12 2005/03/10 13:21:21 ljulliar Exp $
#
...
class SampleClass
  ...
  def initialize(arg1)
	...
	# Create a new Style store for Ruby where user specific settings
	# will be saved
	...
	# and now apply the color settings to the scintilla widget in the dialog box
	...
	# mimic a click on the first style in the lit to get the
	# Ui updated
