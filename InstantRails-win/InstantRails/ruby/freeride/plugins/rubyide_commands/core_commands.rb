...
#
# $Id: core_commands.rb,v 1.15 2005/03/03 00:52:30 ljulliar Exp $
#
    ...
    class CoreCommands
      ...
      def self.start(plugin)
        ...
        cmd_mgr.add("App/Project/CloseAll", "Close &All Projects") do |cmd_slot|
          cmd_slot['/project/current'].manager.close
        end
        ...
        cmd_mgr.add("App/Project/New", "&New Project") do |cmd_slot|
          ##TODO Get project name and frproj file path
          cmd_slot['/project'].manager.open_project(frproj_file, name)
        end
        ...
        cmd_mgr.add("App/File/CloseAll", "C&lose All", "Close All Files...") do |cmd_slot|
          done = true
          cmd_slot['/system/ui/components/EditPane'].each_slot do |editpane|
