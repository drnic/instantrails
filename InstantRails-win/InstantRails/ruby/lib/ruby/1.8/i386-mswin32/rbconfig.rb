...
module Config
  ...
  CONFIG["OBJEXT"] = "obj"
  CONFIG["XCFLAGS"] = "-DRUBY_EXPORT -I. -IC:/develop/win/ruby/ruby-1.8.5 -IC:/develop/win/ruby/ruby-1.8.5/missing"
  ...
  CONFIG["RUNRUBY"] = ".\\ruby.exe \"C:/develop/win/ruby/ruby-1.8.5/runruby.rb\" --extout=\".ext\" --"
  CONFIG["EXTOUT"] = ".ext"
  CONFIG["ARCHFILE"] = ""
  ...
  CONFIG["srcdir"] = "$(DESTDIR)/develop/win/ruby/ruby-1.8.5"
  CONFIG["top_srcdir"] = "C:/develop/win/ruby/ruby-1.8.5"
