...
module Config
  ...
  CONFIG["SET_MAKE"] = ""
  CONFIG["CP"] = "copy > nul"
  CONFIG["INSTALL_PROG"] = "$(INSTALL)"
  CONFIG["INSTALL_DATA"] = "$(INSTALL)"
  CONFIG["LIBOBJS"] = " acosh.obj crypt.obj erf.obj win32.obj"
  CONFIG["ALLOCA"] = ""
  CONFIG["DEFAULT_KCODE"] = ""
  CONFIG["OBJEXT"] = "obj"
  CONFIG["XCFLAGS"] = "-DRUBY_EXPORT -I. -IC:/develop/win/ruby/ruby-1.8.5-p12 -IC:/develop/win/ruby/ruby-1.8.5-p12/missing"
  ...
  CONFIG["RUNRUBY"] = ".\\ruby.exe \"C:/develop/win/ruby/ruby-1.8.5-p12/runruby.rb\" --extout=\".ext\" --"
  CONFIG["EXTOUT"] = ".ext"
  CONFIG["ARCHFILE"] = ""
  ...
  CONFIG["srcdir"] = "$(DESTDIR)/develop/win/ruby/ruby-1.8.5-p12"
  CONFIG["top_srcdir"] = "C:/develop/win/ruby/ruby-1.8.5-p12"
