Gem::Specification.new do |s|
  ...
  s.files = ["lib/win32/file/stat.rb", "CHANGES", "CVS", "install.rb", "lib", "MANIFEST", "README", "test", "win32-file-stat.gemspec", "test/CVS", "test/sometestfile.exe", "test/sometestfile.txt", "test/tc_file_stat.rb"]
