Gem::Specification.new do |s|
  ...
  s.files = ["doc/conversion_guide.txt", "lib/windows/clipboard.rb", "lib/windows/console.rb", "lib/windows/device_io.rb", "lib/windows/directory.rb", "lib/windows/error.rb", "lib/windows/eventlog.rb", "lib/windows/file.rb", "lib/windows/filesystem.rb", "lib/windows/handle.rb", "lib/windows/library.rb", "lib/windows/limits.rb", "lib/windows/memory.rb", "lib/windows/national.rb", "lib/windows/path.rb", "lib/windows/pipe.rb", "lib/windows/process.rb", "lib/windows/registry.rb", "lib/windows/security.rb", "lib/windows/service.rb", "lib/windows/shell.rb", "lib/windows/sound.rb", "lib/windows/synchronize.rb", "lib/windows/system_info.rb", "lib/windows/unicode.rb", "lib/windows/window.rb", "test/ts_all.rb", "lib/windows/msvcrt/buffer.rb", "lib/windows/msvcrt/file.rb", "lib/windows/msvcrt/string.rb", "test/CVS", "test/tc_clipboard.rb", "test/tc_console.rb", "test/tc_error.rb", "test/tc_eventlog.rb", "test/tc_file.rb", "test/tc_memory.rb", "test/tc_msvcrt_buffer.rb", "test/tc_path.rb", "test/tc_pipe.rb", "test/tc_process.rb", "test/tc_registry.rb", "test/tc_security.rb", "test/tc_synchronize.rb", "test/tc_unicode.rb", "CHANGES", "CVS", "MANIFEST", "README"]
