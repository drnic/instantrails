Gem::Specification.new do |s|
  ...
  s.files = ["lib/win32/eventlog.rb", "lib/win32/mc.rb", "lib/win32/test.rb", "test/CVS", "test/foo.mc", "test/tc_eventlog.rb", "test/tc_mc.rb", "test/ts_all.rb", "CHANGES", "CVS", "MANIFEST", "README", "doc/tutorial.txt"]
