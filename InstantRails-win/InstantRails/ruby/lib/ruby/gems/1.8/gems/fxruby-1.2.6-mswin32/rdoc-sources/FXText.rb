module Fox
  ...
  #   is a two-element array indicating the position at which
  #   the text was inserted and the number of characters inserted.
  # +SEL_DELETED+::
  #   sent before text is removed from the text buffer; the message data is
  #   a two-element array indicating the position at which
  #   text will be removed and the number of characters to be removed.
  # +SEL_CHANGED+::
  ...
  class FXText < FXScrollArea
    ...
    # Extract _n_ characters of text from position _pos_ in the text buffer
    def extractText(pos, n); end
    
    # Extract _n_ characters of style info from position _pos_ in the style buffer
    ...
    # buffer to _style_. Here, _style_ is either an integer into the
    # style table, indicating the new style for all the affected characters;
    # or _style_ is a String...
