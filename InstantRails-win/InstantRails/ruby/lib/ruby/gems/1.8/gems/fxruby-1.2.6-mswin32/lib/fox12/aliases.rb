...
module Fox
  ...
  class FXMenuCheck
    alias check		getCheck
    alias check=	setCheck
    alias boxColor	getBoxColor
    alias boxColor=	setBoxColor
  end
  class FXMenuCommand
  ...
  class FXMenuRadio
    alias check		getCheck
    alias check=	setCheck
    alias radioColor	getRadioColor
  ...
  class FXRadioButton
    ...
    def check=(*args)		# also deprecated
      setCheck(*args)
    end
    def checked?
  ...
  class FXToolBar
    def dryDock(*args) # :nodoc:
      getDryDock(*args)
    end
    def wetDock(*args) # :nodoc:
      getWetDock(*args)
    end
    def docked?(*args) # :nodoc:
      isDocked(*args)
    end
    def dockingSide=(*args) # :nodoc:
      setDockingSide(*args)
    end
    def dockingSide(*args) # :nodoc:
      getDockingSide(*args)
