module Fox
  ...
  class FXWindow < FXDrawable
    ...
    # Window width, in pixels [Integer]
    attr_accessor	:width

    # Window height, in pixels [Integer]
    ...
    # Move this window to the specified position (_x_, _y_) in the parent's coordinates.
    def move(x, y) ; end
  
    # Resize this window to the specified width and height (_w_, _h_).
    def resize(w, h) ; end
    ...
    # Change the parent for this window to _newParent_.
